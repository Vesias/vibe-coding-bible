    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <SacredGeometry 
          ...
          className="absolute top-1/4 right-1/4 opacity-[0.03] scale-150 text-yellow-400" 
        />
        <SacredGeometry 
          pattern="vesica-piscis" 
          className="absolute bottom-1/4 left-1/4 opacity-[0.03] scale-75 text-purple-400" 
        />
        <SacredGeometry 
          pattern="flower-of-life" 
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-[0.02] scale-200 text-yellow-400" 
        />
      </div>
      ...
      <div className="relative z-10">
        {/* Sacred Header */}
        <motion.div 
          className="bg-black/20 backdrop-blur-md border-b border-yellow-400/20"
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              >
                <div className="relative">
                  <div className="p-3 bg-gradient-to-br from-yellow-400/20 to-purple-400/20 rounded-xl border border-yellow-400/30 backdrop-blur-sm">
                    <Crown className="h-8 w-8 text-yellow-400" />
                  </div>
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-br from-yellow-400/10 to-purple-400/10 rounded-xl"
                ...
                <div>
                  <motion.h1 
                    className="text-3xl font-bold bg-gradient-to-r from-yellow-400 via-white to-purple-400 bg-clip-text text-transparent"
              ...
              >
                ...
                <div className="flex items-center gap-2 text-sm text-yellow-400 bg-yellow-400/10 px-3 py-2 rounded-lg backdrop-blur-sm border border-yellow-400/20">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid gap-8 lg:grid-cols-4">
            ...
            >
              ...
              <div className="grid gap-4 md:grid-cols-4 mb-8">
                <motion.div
                  ...
                  transition={{ type: "spring", stiffness: 300 }}
                >
                  <Card className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-yellow-400/20 hover:border-yellow-400/40 transition-all duration-300">
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-yellow-400 mb-1">{userProgress.xpEarned}/{workshop.xp}</div>
                ...
                <motion.div
                  ...
                  transition={{ type: "spring", stiffness: 300 }}
                >
                  <Card className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-purple-400/20 hover:border-purple-400/40 transition-all duration-300">
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-purple-400 mb-1">{userProgress.exercisesCompleted}/{userProgress.totalExercises}</div>
              ...
              <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
                ...
                >
                  <TabsList className="grid w-full grid-cols-4 bg-black/20 backdrop-blur-sm border border-yellow-400/20 p-1">
                    <TabsTrigger 
                      value="content" 
                      className="flex items-center gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-yellow-400/20 data-[state=active]:to-purple-400/20 data-[state=active]:text-white transition-all duration-300"
                    >
            ...
            >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-center">
                      <div className="bg-yellow-400/10 rounded-lg p-3 border border-yellow-400/20">
                        <div className="text-xl font-bold text-yellow-400">{userProgress.xpEarned}</div>
                      ...
                      <div className="bg-purple-400/10 rounded-lg p-3 border border-purple-400/20">
                        <div className="text-xl font-bold text-purple-400">{userProgress.exercisesCompleted}/{userProgress.totalExercises}</div>
              ...
              {/* Quick Actions */}
              <Card className="bg-gradient-to-br from-black/40 to-black/60 backdrop-blur-sm border border-purple-400/30 hover:border-purple-400/50 transition-all duration-300">
              ...
              <Card className="bg-gradient-to-br from-black/40 to-black/60 backdrop-blur-sm border border-white/20 hover:border-white/30 transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    {nextWorkshop && (
                      <Button asChild className="flex-1 bg-gradient-to-r from-yellow-400/20 to-purple-400/20 hover:from-yellow-400/30 hover:to-purple-400/30 border border-yellow-400/30">
